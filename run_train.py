...
@click.option('--train_img_shape', nargs=2, type=click.INT, default=(28, 28))
@click.option('--num_epochs', type=click.INT, default=20)
...
def main(input_folder, train_img_shape, num_epochs, batch_size, learn_rate, output_folder):
    ...
    train_generator = train_datagen.flow_from_directory(input_folder, subset='training', **datagen_config)
    validation_generator = train_datagen.flow_from_directory(input_folder, subset='validation', **datagen_config)
